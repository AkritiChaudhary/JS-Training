...
var pokeapi =
{
  ...
  var ability= pokeapi.abilities
  var be= pokeapi.base_experience
  var h= pokeapi.height
  var mp=pokeapi.held_items.item.url
  var sprites=pokeapi.sprites
  var ar=[pokeapi.stats[0].stat.name,pokeapi.stats[1].stat.name,pokeapi.stats[2].stat.name,pokeapi.stats[3].stat.name,pokeapi.stats[4].stat.name,pokeapi.stats[5].stat.name]
  var sl=pokeapi.types[0].slot
  var w=pokeapi.weight
  var mn=pokeapi.moves[1].version_group_details[0]
  console.log(ability)
  console.log(be)
  console.log(h)
  console.log(mp)
